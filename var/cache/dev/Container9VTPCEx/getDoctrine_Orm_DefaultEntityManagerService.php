...
$a->setNamespace('sf_orm_default_4b94dd18fffcae01ead5a2653d22687e8d3316add13e9f21bbba691c708c09a0');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_4b94dd18fffcae01ead5a2653d22687e8d3316add13e9f21bbba691c708c09a0');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_4b94dd18fffcae01ead5a2653d22687e8d3316add13e9f21bbba691c708c09a0');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\FormulaireRepository' => function () {
    return ($this->privates['App\Repository\FormulaireRepository'] ?? $this->load(__DIR__.'/getFormulaireRepositoryService.php'));
